...
export default function LoginSignupPage({ setIsAuthenticated }) {
  ...
  const handleSignup = async (event) => {
    ...
    try {
      const response = await fetch("https://news-aggregator-with-personlised-re.vercel.app/signup", {
        method: "POST",
  ...
  const handleLogin = async (event) => {
    event.preventDefault();
    try {
      const response = await fetch("https://news-aggregator-with-personlised-re.vercel.app/login", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
